...
type ReleaseGroupEntity struct {
	name    string
...
func NewReleaseGroupEntity(client *core.MusicbrainzSDK, entopts map[string]any) *ReleaseGroupEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ReleaseGroupEntity) GetName() string { return e.name }
...
func (e *ReleaseGroupEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ReleaseGroupEntity) Deleted() bool {
	return e.deleted
}


func (e *ReleaseGroupEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewReleaseGroupEntity(e.client, opts)
}

func (e *ReleaseGroupEntity) Data(args ...any) any {
...
func (e *ReleaseGroupEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an ReleaseGroup; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ReleaseGroupEntity) DataTyped(data ...ReleaseGroup) ReleaseGroup {
	if len(data) > 0 {
		return typedFrom[ReleaseGroup](e.Data(asMap(data[0])))
	}
	return typedFrom[ReleaseGroup](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through ReleaseGroup (all fields
// optional at the wire level).
func (e *ReleaseGroupEntity) MatchTyped(match ...ReleaseGroup) ReleaseGroup {
	if len(match) > 0 {
		return typedFrom[ReleaseGroup](e.Match(asMap(match[0])))
	}
	return typedFrom[ReleaseGroup](e.Match())
}
...
func (e *ReleaseGroupEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ReleaseGroupEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ReleaseGroupLoadMatch and returns an ReleaseGroup. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *ReleaseGroupEntity) LoadTyped(reqmatch ReleaseGroupLoadMatch, ctrl map[string]any) (ReleaseGroup, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return ReleaseGroup{}, err
	}
	return typedFrom[ReleaseGroup](res), nil
}




func (e *ReleaseGroupEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// ReleaseGroupListMatch and returns []ReleaseGroup. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *ReleaseGroupEntity) ListTyped(reqmatch ReleaseGroupListMatch, ctrl map[string]any) ([]ReleaseGroup, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[ReleaseGroup](res), nil
}



func (e *ReleaseGroupEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ReleaseGroupEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ReleaseGroupEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ReleaseGroupEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
