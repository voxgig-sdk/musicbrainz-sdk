...
func NewLabelEntity(client *core.MusicbrainzSDK, entopts map[string]any) *LabelEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *LabelEntity) GetName() string { return e.name }
...
func (e *LabelEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *LabelEntity) Deleted() bool {
	return e.deleted
}


func (e *LabelEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewLabelEntity(e.client, opts)
}

func (e *LabelEntity) Data(args ...any) any {
...
func (e *LabelEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *LabelEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *LabelEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
func (e *LabelEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *LabelEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *LabelEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *LabelEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
