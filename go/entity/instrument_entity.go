...
func NewInstrumentEntity(client *core.MusicbrainzSDK, entopts map[string]any) *InstrumentEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *InstrumentEntity) GetName() string { return e.name }
...
func (e *InstrumentEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *InstrumentEntity) Deleted() bool {
	return e.deleted
}


func (e *InstrumentEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewInstrumentEntity(e.client, opts)
}

func (e *InstrumentEntity) Data(args ...any) any {
...
func (e *InstrumentEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Instrument; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *InstrumentEntity) DataTyped(data ...Instrument) Instrument {
	if len(data) > 0 {
		return typedFrom[Instrument](e.Data(asMap(data[0])))
	}
	return typedFrom[Instrument](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Instrument (all fields
// optional at the wire level).
func (e *InstrumentEntity) MatchTyped(match ...Instrument) Instrument {
	if len(match) > 0 {
		return typedFrom[Instrument](e.Match(asMap(match[0])))
	}
	return typedFrom[Instrument](e.Match())
}
...
func (e *InstrumentEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *InstrumentEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// InstrumentLoadMatch and returns an Instrument. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *InstrumentEntity) LoadTyped(reqmatch InstrumentLoadMatch, ctrl map[string]any) (Instrument, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Instrument{}, err
	}
	return typedFrom[Instrument](res), nil
}




func (e *InstrumentEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// InstrumentListMatch and returns []Instrument. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *InstrumentEntity) ListTyped(reqmatch InstrumentListMatch, ctrl map[string]any) ([]Instrument, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Instrument](res), nil
}



func (e *InstrumentEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *InstrumentEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *InstrumentEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *InstrumentEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
