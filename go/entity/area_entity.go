...
func NewAreaEntity(client *core.MusicbrainzSDK, entopts map[string]any) *AreaEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *AreaEntity) GetName() string { return e.name }
...
func (e *AreaEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *AreaEntity) Deleted() bool {
	return e.deleted
}


func (e *AreaEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewAreaEntity(e.client, opts)
}

func (e *AreaEntity) Data(args ...any) any {
...
func (e *AreaEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Area; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *AreaEntity) DataTyped(data ...Area) Area {
	if len(data) > 0 {
		return typedFrom[Area](e.Data(asMap(data[0])))
	}
	return typedFrom[Area](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Area (all fields
// optional at the wire level).
func (e *AreaEntity) MatchTyped(match ...Area) Area {
	if len(match) > 0 {
		return typedFrom[Area](e.Match(asMap(match[0])))
	}
	return typedFrom[Area](e.Match())
}
...
func (e *AreaEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *AreaEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// AreaLoadMatch and returns an Area. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *AreaEntity) LoadTyped(reqmatch AreaLoadMatch, ctrl map[string]any) (Area, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Area{}, err
	}
	return typedFrom[Area](res), nil
}




func (e *AreaEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// AreaListMatch and returns []Area. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *AreaEntity) ListTyped(reqmatch AreaListMatch, ctrl map[string]any) ([]Area, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Area](res), nil
}



func (e *AreaEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *AreaEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *AreaEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *AreaEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
