...
func NewGenreEntity(client *core.MusicbrainzSDK, entopts map[string]any) *GenreEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *GenreEntity) GetName() string { return e.name }
...
func (e *GenreEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *GenreEntity) Deleted() bool {
	return e.deleted
}


func (e *GenreEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewGenreEntity(e.client, opts)
}

func (e *GenreEntity) Data(args ...any) any {
...
func (e *GenreEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *GenreEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *GenreEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// GenreLoadMatch and returns an Genre. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *GenreEntity) LoadTyped(reqmatch GenreLoadMatch, ctrl map[string]any) (Genre, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Genre{}, err
	}
	return typedFrom[Genre](res), nil
}




func (e *GenreEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
func (e *GenreEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *GenreEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *GenreEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *GenreEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
