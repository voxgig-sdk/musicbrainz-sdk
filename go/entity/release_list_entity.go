...
func NewReleaseListEntity(client *core.MusicbrainzSDK, entopts map[string]any) *ReleaseListEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ReleaseListEntity) GetName() string { return e.name }
...
func (e *ReleaseListEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ReleaseListEntity) Deleted() bool {
	return e.deleted
}


func (e *ReleaseListEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewReleaseListEntity(e.client, opts)
}

func (e *ReleaseListEntity) Data(args ...any) any {
...
func (e *ReleaseListEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an ReleaseList; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ReleaseListEntity) DataTyped(data ...ReleaseList) ReleaseList {
	if len(data) > 0 {
		return typedFrom[ReleaseList](e.Data(asMap(data[0])))
	}
	return typedFrom[ReleaseList](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through ReleaseList (all fields
// optional at the wire level).
func (e *ReleaseListEntity) MatchTyped(match ...ReleaseList) ReleaseList {
	if len(match) > 0 {
		return typedFrom[ReleaseList](e.Match(asMap(match[0])))
	}
	return typedFrom[ReleaseList](e.Match())
}
...
func (e *ReleaseListEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ReleaseListEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ReleaseListLoadMatch and returns an ReleaseList. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *ReleaseListEntity) LoadTyped(reqmatch ReleaseListLoadMatch, ctrl map[string]any) (ReleaseList, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return ReleaseList{}, err
	}
	return typedFrom[ReleaseList](res), nil
}



func (e *ReleaseListEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *ReleaseListEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ReleaseListEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ReleaseListEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ReleaseListEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
