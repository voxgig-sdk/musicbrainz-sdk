...
func NewReleaseEntity(client *core.MusicbrainzSDK, entopts map[string]any) *ReleaseEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ReleaseEntity) GetName() string { return e.name }
...
func (e *ReleaseEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ReleaseEntity) Deleted() bool {
	return e.deleted
}


func (e *ReleaseEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewReleaseEntity(e.client, opts)
}

func (e *ReleaseEntity) Data(args ...any) any {
...
func (e *ReleaseEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Release; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ReleaseEntity) DataTyped(data ...Release) Release {
	if len(data) > 0 {
		return typedFrom[Release](e.Data(asMap(data[0])))
	}
	return typedFrom[Release](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Release (all fields
// optional at the wire level).
func (e *ReleaseEntity) MatchTyped(match ...Release) Release {
	if len(match) > 0 {
		return typedFrom[Release](e.Match(asMap(match[0])))
	}
	return typedFrom[Release](e.Match())
}
...
func (e *ReleaseEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ReleaseEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ReleaseLoadMatch and returns an Release. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *ReleaseEntity) LoadTyped(reqmatch ReleaseLoadMatch, ctrl map[string]any) (Release, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Release{}, err
	}
	return typedFrom[Release](res), nil
}




func (e *ReleaseEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// ReleaseListMatch and returns []Release. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *ReleaseEntity) ListTyped(reqmatch ReleaseListMatch, ctrl map[string]any) ([]Release, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Release](res), nil
}



func (e *ReleaseEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ReleaseEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ReleaseEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ReleaseEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
