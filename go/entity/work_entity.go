...
func NewWorkEntity(client *core.MusicbrainzSDK, entopts map[string]any) *WorkEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *WorkEntity) GetName() string { return e.name }
...
func (e *WorkEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *WorkEntity) Deleted() bool {
	return e.deleted
}


func (e *WorkEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewWorkEntity(e.client, opts)
}

func (e *WorkEntity) Data(args ...any) any {
...
func (e *WorkEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Work; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *WorkEntity) DataTyped(data ...Work) Work {
	if len(data) > 0 {
		return typedFrom[Work](e.Data(asMap(data[0])))
	}
	return typedFrom[Work](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Work (all fields
// optional at the wire level).
func (e *WorkEntity) MatchTyped(match ...Work) Work {
	if len(match) > 0 {
		return typedFrom[Work](e.Match(asMap(match[0])))
	}
	return typedFrom[Work](e.Match())
}
...
func (e *WorkEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *WorkEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// WorkLoadMatch and returns an Work. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *WorkEntity) LoadTyped(reqmatch WorkLoadMatch, ctrl map[string]any) (Work, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Work{}, err
	}
	return typedFrom[Work](res), nil
}




func (e *WorkEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// WorkListMatch and returns []Work. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *WorkEntity) ListTyped(reqmatch WorkListMatch, ctrl map[string]any) ([]Work, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Work](res), nil
}



func (e *WorkEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *WorkEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *WorkEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *WorkEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
