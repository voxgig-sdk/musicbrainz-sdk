...
func NewTagEntity(client *core.MusicbrainzSDK, entopts map[string]any) *TagEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *TagEntity) GetName() string { return e.name }
...
func (e *TagEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *TagEntity) Deleted() bool {
	return e.deleted
}


func (e *TagEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewTagEntity(e.client, opts)
}

func (e *TagEntity) Data(args ...any) any {
...
func (e *TagEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Tag; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *TagEntity) DataTyped(data ...Tag) Tag {
	if len(data) > 0 {
		return typedFrom[Tag](e.Data(asMap(data[0])))
	}
	return typedFrom[Tag](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Tag (all fields
// optional at the wire level).
func (e *TagEntity) MatchTyped(match ...Tag) Tag {
	if len(match) > 0 {
		return typedFrom[Tag](e.Match(asMap(match[0])))
	}
	return typedFrom[Tag](e.Match())
}
...
func (e *TagEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *TagEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// TagLoadMatch and returns an Tag. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *TagEntity) LoadTyped(reqmatch TagLoadMatch, ctrl map[string]any) (Tag, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Tag{}, err
	}
	return typedFrom[Tag](res), nil
}



func (e *TagEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *TagEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// TagCreateData and returns an Tag. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *TagEntity) CreateTyped(reqdata TagCreateData, ctrl map[string]any) (Tag, error) {
...
func (e *TagEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *TagEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *TagEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
