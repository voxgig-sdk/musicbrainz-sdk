...
func NewArtistEntity(client *core.MusicbrainzSDK, entopts map[string]any) *ArtistEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ArtistEntity) GetName() string { return e.name }
...
func (e *ArtistEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ArtistEntity) Deleted() bool {
	return e.deleted
}


func (e *ArtistEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewArtistEntity(e.client, opts)
}

func (e *ArtistEntity) Data(args ...any) any {
...
func (e *ArtistEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Artist; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ArtistEntity) DataTyped(data ...Artist) Artist {
	if len(data) > 0 {
		return typedFrom[Artist](e.Data(asMap(data[0])))
	}
	return typedFrom[Artist](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Artist (all fields
// optional at the wire level).
func (e *ArtistEntity) MatchTyped(match ...Artist) Artist {
	if len(match) > 0 {
		return typedFrom[Artist](e.Match(asMap(match[0])))
	}
	return typedFrom[Artist](e.Match())
}
...
func (e *ArtistEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ArtistEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ArtistLoadMatch and returns an Artist. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *ArtistEntity) LoadTyped(reqmatch ArtistLoadMatch, ctrl map[string]any) (Artist, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Artist{}, err
	}
	return typedFrom[Artist](res), nil
}




func (e *ArtistEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// ArtistListMatch and returns []Artist. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *ArtistEntity) ListTyped(reqmatch ArtistListMatch, ctrl map[string]any) ([]Artist, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Artist](res), nil
}



func (e *ArtistEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ArtistEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ArtistEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ArtistEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
