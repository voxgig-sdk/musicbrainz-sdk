...
type RecordingListEntity struct {
	name    string
...
func NewRecordingListEntity(client *core.MusicbrainzSDK, entopts map[string]any) *RecordingListEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *RecordingListEntity) GetName() string { return e.name }
...
func (e *RecordingListEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *RecordingListEntity) Deleted() bool {
	return e.deleted
}


func (e *RecordingListEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewRecordingListEntity(e.client, opts)
}

func (e *RecordingListEntity) Data(args ...any) any {
...
func (e *RecordingListEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an RecordingList; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *RecordingListEntity) DataTyped(data ...RecordingList) RecordingList {
	if len(data) > 0 {
		return typedFrom[RecordingList](e.Data(asMap(data[0])))
	}
	return typedFrom[RecordingList](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through RecordingList (all fields
// optional at the wire level).
func (e *RecordingListEntity) MatchTyped(match ...RecordingList) RecordingList {
	if len(match) > 0 {
		return typedFrom[RecordingList](e.Match(asMap(match[0])))
	}
	return typedFrom[RecordingList](e.Match())
}
...
func (e *RecordingListEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *RecordingListEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// RecordingListLoadMatch and returns an RecordingList. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *RecordingListEntity) LoadTyped(reqmatch RecordingListLoadMatch, ctrl map[string]any) (RecordingList, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return RecordingList{}, err
	}
	return typedFrom[RecordingList](res), nil
}



func (e *RecordingListEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *RecordingListEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *RecordingListEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *RecordingListEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *RecordingListEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
