...
func NewRecordingEntity(client *core.MusicbrainzSDK, entopts map[string]any) *RecordingEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *RecordingEntity) GetName() string { return e.name }
...
func (e *RecordingEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *RecordingEntity) Deleted() bool {
	return e.deleted
}


func (e *RecordingEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewRecordingEntity(e.client, opts)
}

func (e *RecordingEntity) Data(args ...any) any {
...
func (e *RecordingEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Recording; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *RecordingEntity) DataTyped(data ...Recording) Recording {
	if len(data) > 0 {
		return typedFrom[Recording](e.Data(asMap(data[0])))
	}
	return typedFrom[Recording](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Recording (all fields
// optional at the wire level).
func (e *RecordingEntity) MatchTyped(match ...Recording) Recording {
	if len(match) > 0 {
		return typedFrom[Recording](e.Match(asMap(match[0])))
	}
	return typedFrom[Recording](e.Match())
}
...
func (e *RecordingEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *RecordingEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// RecordingLoadMatch and returns an Recording. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *RecordingEntity) LoadTyped(reqmatch RecordingLoadMatch, ctrl map[string]any) (Recording, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Recording{}, err
	}
	return typedFrom[Recording](res), nil
}




func (e *RecordingEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// RecordingListMatch and returns []Recording. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *RecordingEntity) ListTyped(reqmatch RecordingListMatch, ctrl map[string]any) ([]Recording, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Recording](res), nil
}



func (e *RecordingEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *RecordingEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *RecordingEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *RecordingEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
