...
func NewCollectionEntity(client *core.MusicbrainzSDK, entopts map[string]any) *CollectionEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CollectionEntity) GetName() string { return e.name }
...
func (e *CollectionEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CollectionEntity) Deleted() bool {
	return e.deleted
}


func (e *CollectionEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCollectionEntity(e.client, opts)
}

func (e *CollectionEntity) Data(args ...any) any {
...
func (e *CollectionEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Collection; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CollectionEntity) DataTyped(data ...Collection) Collection {
	if len(data) > 0 {
		return typedFrom[Collection](e.Data(asMap(data[0])))
	}
	return typedFrom[Collection](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Collection (all fields
// optional at the wire level).
func (e *CollectionEntity) MatchTyped(match ...Collection) Collection {
	if len(match) > 0 {
		return typedFrom[Collection](e.Match(asMap(match[0])))
	}
	return typedFrom[Collection](e.Match())
}
...
func (e *CollectionEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CollectionEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *CollectionEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CollectionListMatch and returns []Collection. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *CollectionEntity) ListTyped(reqmatch CollectionListMatch, ctrl map[string]any) ([]Collection, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Collection](res), nil
}



func (e *CollectionEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *CollectionEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CollectionEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CollectionEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
