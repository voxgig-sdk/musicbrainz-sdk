...
func NewPlaceEntity(client *core.MusicbrainzSDK, entopts map[string]any) *PlaceEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *PlaceEntity) GetName() string { return e.name }
...
func (e *PlaceEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *PlaceEntity) Deleted() bool {
	return e.deleted
}


func (e *PlaceEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewPlaceEntity(e.client, opts)
}

func (e *PlaceEntity) Data(args ...any) any {
...
func (e *PlaceEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Place; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *PlaceEntity) DataTyped(data ...Place) Place {
	if len(data) > 0 {
		return typedFrom[Place](e.Data(asMap(data[0])))
	}
	return typedFrom[Place](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Place (all fields
// optional at the wire level).
func (e *PlaceEntity) MatchTyped(match ...Place) Place {
	if len(match) > 0 {
		return typedFrom[Place](e.Match(asMap(match[0])))
	}
	return typedFrom[Place](e.Match())
}
...
func (e *PlaceEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *PlaceEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// PlaceLoadMatch and returns an Place. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *PlaceEntity) LoadTyped(reqmatch PlaceLoadMatch, ctrl map[string]any) (Place, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Place{}, err
	}
	return typedFrom[Place](res), nil
}




func (e *PlaceEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// PlaceListMatch and returns []Place. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *PlaceEntity) ListTyped(reqmatch PlaceListMatch, ctrl map[string]any) ([]Place, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Place](res), nil
}



func (e *PlaceEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *PlaceEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *PlaceEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *PlaceEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
