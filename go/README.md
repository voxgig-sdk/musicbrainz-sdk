...
The Golang SDK for the Musicbrainz API. Provides an entity-oriented interface using standard Go conventions — no generics required, data flows as `map[string]any`.


## Install
```bash
go get github.com/voxgig-sdk/musicbrainz-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/musicbrainz-sdk=../path/to/github.com/voxgig-sdk/musicbrainz-sdk
```
...
```
github.com/voxgig-sdk/musicbrainz-sdk/
...
The root package (`github.com/voxgig-sdk/musicbrainz-sdk`) re-exports everything needed
