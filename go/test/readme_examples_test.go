...
const testSeed = `map[string]any{"entity": map[string]any{"area": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "artist": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "collection": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "event": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "genre": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "instrument": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "label": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "place": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "rating": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "recording": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "recording_list": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "release": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "release_group": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "release_list": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "series": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "tag": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "url": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "work": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "work_list": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
