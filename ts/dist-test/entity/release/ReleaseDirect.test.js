...
(0, node_test_1.describe)('ReleaseDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-release', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-release', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-release', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-release', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    const env = (0, utility_1.envOverride)({
        'MUSICBRAINZ_TEST_RELEASE_ENTID': {},
    ...
    if (live) {
        ...
        let idmap = env['MUSICBRAINZ_TEST_RELEASE_ENTID'];
...
//# sourceMappingURL=ReleaseDirect.test.js.map