...
(0, node_test_1.describe)('WorkListEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'work_list.' + op, live))
                return;
        }
        ...
        let work_list_ref01_data = Object.values(setup.data.existing.work_list)[0];
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/work_list/WorkListTestData.json');
    ...
    let idmap = transform(['work_list01', 'work_list02', 'work_list03', 'iswc01', 'iswc02', 'iswc03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['MUSICBRAINZ_TEST_WORK_LIST_ENTID'];
...
//# sourceMappingURL=WorkListEntity.test.js.map