...
(0, node_test_1.describe)('WorkListDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-work_list', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-work_list', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["iswc01"]))
            return;
...
function directSetup(mockres) {
    ...
    const env = (0, utility_1.envOverride)({
        'MUSICBRAINZ_TEST_WORK_LIST_ENTID': {},
    ...
    if (live) {
        ...
        let idmap = env['MUSICBRAINZ_TEST_WORK_LIST_ENTID'];
...
//# sourceMappingURL=WorkListDirect.test.js.map