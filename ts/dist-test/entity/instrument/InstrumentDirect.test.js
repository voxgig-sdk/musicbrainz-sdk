...
(0, node_test_1.describe)('InstrumentDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-instrument', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-instrument', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-instrument', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-instrument', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['MUSICBRAINZ_TEST_INSTRUMENT_ENTID'];
...
//# sourceMappingURL=InstrumentDirect.test.js.map