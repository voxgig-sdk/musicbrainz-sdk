...
(0, node_test_1.describe)('RecordingListEntity', async () => {
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/recording_list/RecordingListTestData.json');
    ...
    let idmap = transform(['recording_list01', 'recording_list02', 'recording_list03', 'isrc01', 'isrc02', 'isrc03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    idmap = env['MUSICBRAINZ_TEST_RECORDING_LIST_ENTID'];
    const live = 'TRUE' === env.MUSICBRAINZ_TEST_LIVE;
    const transport = (0, live_runner_1.createLiveTransport)();
    if (live) {
        const rawIds = process.env['MUSICBRAINZ_TEST_RECORDING_LIST_ENTID'];
...
//# sourceMappingURL=RecordingListEntity.test.js.map