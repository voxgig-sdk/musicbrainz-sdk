...
(0, node_test_1.describe)('RecordingEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['list', 'load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'recording.' + op, live))
                return;
        }
        ...
        // LOAD
        const recording_ref01_match_dt0 = {};
        ...
        (0, node_assert_1.default)(recording_ref01_data_dt0.id === recording_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const idmapEnvVal = process.env['MUSICBRAINZ_TEST_RECORDING_ENTID'];
