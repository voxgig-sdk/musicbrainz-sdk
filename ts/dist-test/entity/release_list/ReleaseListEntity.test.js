...
(0, node_test_1.describe)('ReleaseListEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if (!live && (0, utility_1.maybeSkipControl)(t, 'entityOp', 'release_list.' + op, live))
                return;
        }
        ...
        let release_list_ref01_data = Object.values(setup.data.existing.release_list)[0];
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/release_list/ReleaseListTestData.json');
    ...
    let idmap = transform(['release_list01', 'release_list02', 'release_list03', 'discid01', 'discid02', 'discid03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=ReleaseListEntity.test.js.map