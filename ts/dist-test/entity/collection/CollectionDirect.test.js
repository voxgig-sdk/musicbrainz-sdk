...
(0, node_test_1.describe)('CollectionDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-collection', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-collection', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['MUSICBRAINZ_TEST_COLLECTION_ENTID'];
...
//# sourceMappingURL=CollectionDirect.test.js.map