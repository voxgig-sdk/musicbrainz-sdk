...
(0, node_test_1.describe)('ArtistDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-artist', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-artist', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-artist', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-artist', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['MUSICBRAINZ_TEST_ARTIST_ENTID'];
...
//# sourceMappingURL=ArtistDirect.test.js.map