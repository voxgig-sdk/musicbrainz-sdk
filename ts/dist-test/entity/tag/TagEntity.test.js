...
(0, node_test_1.describe)('TagEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create', 'load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'tag.' + op, live))
                return;
        }
        ...
        if (setup.syntheticOnly) {
            t.skip('live entity test uses synthetic IDs from fixture — set MUSICBRAINZ_TEST_TAG_ENTID JSON to run live');
            return;
        }
...
function basicSetup(extra) {
    ...
    const idmapEnvVal = process.env['MUSICBRAINZ_TEST_TAG_ENTID'];
