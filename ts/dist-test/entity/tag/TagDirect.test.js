...
(0, node_test_1.describe)('TagDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-tag', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-tag', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['MUSICBRAINZ_TEST_TAG_ENTID'];
...
//# sourceMappingURL=TagDirect.test.js.map