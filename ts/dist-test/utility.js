...
function envOverride(m) {
    if ('TRUE' === process.env.MUSICBRAINZ_TEST_LIVE ||
        'TRUE' === process.env.MUSICBRAINZ_TEST_OVERRIDE) {
    ...
    m.MUSICBRAINZ_TEST_EXPLAIN = process.env.MUSICBRAINZ_TEST_EXPLAIN || m.MUSICBRAINZ_TEST_EXPLAIN;
    return m;
}
