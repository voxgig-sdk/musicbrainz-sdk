...
exports.SDK = exports.MusicbrainzSDK = exports.MusicbrainzEntityBase = exports.BaseFeature = exports.config = exports.stdutil = void 0;
const AreaEntity_1 = require("./entity/AreaEntity");
const ArtistEntity_1 = require("./entity/ArtistEntity");
...
const InstrumentEntity_1 = require("./entity/InstrumentEntity");
...
const RecordingListEntity_1 = require("./entity/RecordingListEntity");
const ReleaseEntity_1 = require("./entity/ReleaseEntity");
const ReleaseGroupEntity_1 = require("./entity/ReleaseGroupEntity");
const ReleaseListEntity_1 = require("./entity/ReleaseListEntity");
const SeriesEntity_1 = require("./entity/SeriesEntity");
const TagEntity_1 = require("./entity/TagEntity");
const UrlEntity_1 = require("./entity/UrlEntity");
const WorkEntity_1 = require("./entity/WorkEntity");
const WorkListEntity_1 = require("./entity/WorkListEntity");
const node_util_1 = require("node:util");
const Config_1 = require("./Config");
Object.defineProperty(exports, "config", { enumerable: true, get: function () { return Config_1.config; } });
const MusicbrainzEntityBase_1 = require("./MusicbrainzEntityBase");
Object.defineProperty(exports, "MusicbrainzEntityBase", { enumerable: true, get: function () { return MusicbrainzEntityBase_1.MusicbrainzEntityBase; } });
...
class MusicbrainzSDK {
    ...
    async graphql(query, variables, ctrl) {
        ...
        if (null != errors && Array.isArray(errors) && 0 < errors.length) {
            ...
            const err = new Error('MusicbrainzSDK: graphql: ' +
    ...
    Area(entopts) {
        const self = this;
        return new AreaEntity_1.AreaEntity(self, entopts);
    }
    ...
    Artist(entopts) {
        const self = this;
        return new ArtistEntity_1.ArtistEntity(self, entopts);
    }
    ...
    Instrument(entopts) {
        const self = this;
        return new InstrumentEntity_1.InstrumentEntity(self, entopts);
    }
    ...
    // The argument is the entity OPTIONS object (passed to the entity
    // constructor as entopts), not initial entity data.
    RecordingList(entopts) {
        const self = this;
        return new RecordingListEntity_1.RecordingListEntity(self, entopts);
    }
    ...
    // The argument is the entity OPTIONS object (passed to the entity
    // constructor as entopts), not initial entity data.
    ReleaseGroup(entopts) {
        const self = this;
        return new ReleaseGroupEntity_1.ReleaseGroupEntity(self, entopts);
    }
    ...
    ReleaseList(entopts) {
        const self = this;
        return new ReleaseListEntity_1.ReleaseListEntity(self, entopts);
    }
    ...
    Series(entopts) {
        const self = this;
        return new SeriesEntity_1.SeriesEntity(self, entopts);
    }
    ...
    Url(entopts) {
        const self = this;
        return new UrlEntity_1.UrlEntity(self, entopts);
    }
    ...
    Work(entopts) {
        const self = this;
        return new WorkEntity_1.WorkEntity(self, entopts);
    }
    ...
    WorkList(entopts) {
        const self = this;
        return new WorkListEntity_1.WorkListEntity(self, entopts);
    }
...
exports.MusicbrainzSDK = MusicbrainzSDK;
const SDK = MusicbrainzSDK;
exports.SDK = SDK;
//# sourceMappingURL=MusicbrainzSDK.js.map