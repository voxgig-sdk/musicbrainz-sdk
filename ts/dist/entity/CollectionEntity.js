...
class CollectionEntity extends MusicbrainzEntityBase_1.MusicbrainzEntityBase {
    constructor(client, entopts) {
        super(client, entopts);
        this.name = 'collection';
        this.name_ = 'collection';
        this.Name = 'Collection';
    }
    make() {
        return new CollectionEntity(this._client, this.entopts());
    }
    async list(reqmatch, ctrl) {
        ...
        try {
            ...
            if (err) {
                ...
                // Promise<Collection[]> return stays clean under strict null checks.
                return undefined;
            }
        }
    }
