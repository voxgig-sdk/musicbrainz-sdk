...
class TagEntity extends MusicbrainzEntityBase<Tag> {
  ...
  async load(this: any, reqmatch?: TagLoadMatch, ctrl?: Control): Promise<TagEntity> {
  ...
  async create(this: any, reqdata?: TagCreateData, ctrl?: Control): Promise<TagEntity> {
