...
class AreaEntity extends MusicbrainzEntityBase<Area> {
  ...
  make(this: AreaEntity) {
    return new AreaEntity(this._client, this.entopts())
  }



  async load(this: any, reqmatch?: AreaLoadMatch, ctrl?: Control): Promise<AreaEntity> {
  ...
  async list(this: any, reqmatch?: AreaListMatch, ctrl?: Control): Promise<AreaEntity[]> {
