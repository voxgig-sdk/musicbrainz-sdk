...
class PlaceEntity extends MusicbrainzEntityBase<Place> {
  ...
  make(this: PlaceEntity) {
    return new PlaceEntity(this._client, this.entopts())
  }



  async load(this: any, reqmatch?: PlaceLoadMatch, ctrl?: Control): Promise<PlaceEntity> {
