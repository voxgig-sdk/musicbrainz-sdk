...
class RecordingEntity extends MusicbrainzEntityBase<Recording> {
  ...
  make(this: RecordingEntity) {
    return new RecordingEntity(this._client, this.entopts())
  }



  async load(this: any, reqmatch?: RecordingLoadMatch, ctrl?: Control): Promise<RecordingEntity> {
