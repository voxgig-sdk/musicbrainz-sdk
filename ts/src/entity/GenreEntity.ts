...
class GenreEntity extends MusicbrainzEntityBase<Genre> {
  ...
  make(this: GenreEntity) {
    return new GenreEntity(this._client, this.entopts())
  }



  async load(this: any, reqmatch?: GenreLoadMatch, ctrl?: Control): Promise<GenreEntity> {
