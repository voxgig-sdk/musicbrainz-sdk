...
//     (\`new MusicbrainzSDK(...)\` / \`MusicbrainzSDK.test(...)\` become
//     \`MusicbrainzSDK.test({ entity: ... })\`), transpiled to JS, and run
...
const TEST_SEED = {"entity":{"area":{"test01":{"id":"test01"}},"artist":{"test01":{"id":"test01"}},"collection":{"test01":{"id":"test01"}},"event":{"test01":{"id":"test01"}},"genre":{"test01":{"id":"test01"}},"instrument":{"test01":{"id":"test01"}},"label":{"test01":{"id":"test01"}},"place":{"test01":{"id":"test01"}},"rating":{"test01":{"id":"test01"}},"recording":{"test01":{"id":"test01"}},"recording_list":{"test01":{"id":"test01"}},"release":{"test01":{"id":"test01"}},"release_group":{"test01":{"id":"test01"}},"release_list":{"test01":{"id":"test01"}},"series":{"test01":{"id":"test01"}},"tag":{"test01":{"id":"test01"}},"url":{"test01":{"id":"test01"}},"work":{"test01":{"id":"test01"}},"work_list":{"test01":{"id":"test01"}}}}
...
// rewrite real client construction (\`new MusicbrainzSDK(...)\` and any
// \`MusicbrainzSDK.test(...)\`) to a seeded test-mode client, and give
...
function rewriteForRun(code: string): string {
  ...
  out = out.replace(/new\s+MusicbrainzSDK\s*\([^)]*\)/g, () => SEEDED_CTOR)
  out = out.replace(/MusicbrainzSDK\.test\s*\([^)]*\)/g, () => SEEDED_CTOR)
