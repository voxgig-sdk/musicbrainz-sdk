...
describe('RecordingListEntity', async () => {
  ...
  test('basic', async (t) => {
    ...
    for (const op of ['load']) {
      if (!live && maybeSkipControl(t, 'entityOp', 'recording_list.' + op, live)) return
    }
    ...
    let recording_list_ref01_data = Object.values(setup.data.existing.recording_list)[0] as any
...
function basicSetup(extra?: any) {
  ...
  const entityDataFile =
    Path.resolve(__dirname, 
      '../../../../.sdk/test/entity/recording_list/RecordingListTestData.json')
