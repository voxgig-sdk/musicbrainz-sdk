# Musicbrainz SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions MusicbrainzSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both MusicbrainzSDK(...) and MusicbrainzSDK.test(...) become
#      MusicbrainzSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "musicbrainz_sdk"
_SDK_CLASS = "MusicbrainzSDK"
