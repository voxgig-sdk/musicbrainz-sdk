...
class ReleaseListEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ReleaseListEntity(self._client, opts)
    ...
    def match_get(self) -> ReleaseList:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ReleaseList:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ReleaseList().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
