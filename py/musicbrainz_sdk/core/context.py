...
from musicbrainz_sdk.core.helpers import get_ctx_prop, to_map
...
class MusicbrainzContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, MusicbrainzSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, MusicbrainzResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, MusicbrainzResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return MusicbrainzError(code, msg, self)
