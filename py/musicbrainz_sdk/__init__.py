...
from musicbrainz_sdk.core.spec import MusicbrainzSpec
from musicbrainz_sdk.core import helpers

# Load utility registration (populates Utility._registrar)
from musicbrainz_sdk.utility import register

# Load features
from musicbrainz_sdk.feature.base_feature import MusicbrainzBaseFeature
from musicbrainz_sdk.features import _has_feature, _make_feature
...
class MusicbrainzSDK:
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("MusicbrainzSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Collection(self, data=None) -> "CollectionEntity":
        ...
        from musicbrainz_sdk.entity.collection_entity import CollectionEntity
    ...
    def Event(self, data=None) -> "EventEntity":
        ...
        from musicbrainz_sdk.entity.event_entity import EventEntity
        return EventEntity(self, data)


    def Genre(self, data=None) -> "GenreEntity":
        """Entity factory: client.Genre().list() / client.Genre().load({"id": ...})."""
        from musicbrainz_sdk.entity.genre_entity import GenreEntity
    ...
    def Instrument(self, data=None) -> "InstrumentEntity":
        ...
        from musicbrainz_sdk.entity.instrument_entity import InstrumentEntity
    ...
    def Label(self, data=None) -> "LabelEntity":
        ...
        from musicbrainz_sdk.entity.label_entity import LabelEntity
        return LabelEntity(self, data)


    def Place(self, data=None) -> "PlaceEntity":
        """Entity factory: client.Place().list() / client.Place().load({"id": ...})."""
        from musicbrainz_sdk.entity.place_entity import PlaceEntity
    ...
    def Rating(self, data=None) -> "RatingEntity":
        ...
        from musicbrainz_sdk.entity.rating_entity import RatingEntity
    ...
    def Recording(self, data=None) -> "RecordingEntity":
        ...
        from musicbrainz_sdk.entity.recording_entity import RecordingEntity
    ...
    def RecordingList(self, data=None) -> "RecordingListEntity":
        ...
        from musicbrainz_sdk.entity.recording_list_entity import RecordingListEntity
    ...
    def Release(self, data=None) -> "ReleaseEntity":
        ...
        from musicbrainz_sdk.entity.release_entity import ReleaseEntity
    ...
    def ReleaseGroup(self, data=None) -> "ReleaseGroupEntity":
        ...
        from musicbrainz_sdk.entity.release_group_entity import ReleaseGroupEntity
    ...
    def ReleaseList(self, data=None) -> "ReleaseListEntity":
        ...
        from musicbrainz_sdk.entity.release_list_entity import ReleaseListEntity
    ...
    def WorkList(self, data=None) -> "WorkListEntity":
        ...
        from musicbrainz_sdk.entity.work_list_entity import WorkListEntity
