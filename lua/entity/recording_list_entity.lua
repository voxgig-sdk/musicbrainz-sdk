...
local RecordingListEntity = {}
RecordingListEntity.__index = RecordingListEntity


function RecordingListEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, RecordingListEntity)
  self._name = "recording_list"
  self._client = client
...
function RecordingListEntity:get_name()
  return self._name
end


function RecordingListEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return RecordingListEntity.new(self._client, opts)
end
...
function RecordingListEntity:mark_deleted()
  self._deleted = true
end


function RecordingListEntity:deleted()
  return true == self._deleted
end


function RecordingListEntity:data_set(args)
  if args ~= nil then
...
function RecordingListEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function RecordingListEntity:match_set(args)
  if args ~= nil then
...
function RecordingListEntity:match_get()
...
function RecordingListEntity:stream(action, args, callopts)
...
function RecordingListEntity:_run_op(ctx, post_done)
  local utility = self._utility
