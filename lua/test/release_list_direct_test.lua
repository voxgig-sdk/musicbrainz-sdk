...
describe("ReleaseListDirect", function()
  it("should direct-load-release_list", function()
    local setup = release_list_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-release_list", setup.live and "live" or "unit")
...
function release_list_direct_setup(mockres)
