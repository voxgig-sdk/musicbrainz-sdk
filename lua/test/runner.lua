...
function runner.env_override(m)
  local live = runner.getenv("MUSICBRAINZ_TEST_LIVE")
  local override = runner.getenv("MUSICBRAINZ_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("MUSICBRAINZ_TEST_EXPLAIN")
