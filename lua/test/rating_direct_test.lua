...
describe("RatingDirect", function()
  it("should direct-load-rating", function()
    local setup = rating_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-rating", setup.live and "live" or "unit")
