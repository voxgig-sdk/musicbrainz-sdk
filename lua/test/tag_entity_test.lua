...
describe("TagEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set MUSICBRAINZ_TEST_TAG_ENTID JSON to run live")
      return
    end
...
function tag_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("MUSICBRAINZ_TEST_TAG_ENTID")
