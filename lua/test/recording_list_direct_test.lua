...
describe("RecordingListDirect", function()
  it("should direct-load-recording_list", function()
    local setup = recording_list_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-recording_list", setup.live and "live" or "unit")
...
function recording_list_direct_setup(mockres)
