...
describe("CollectionDirect", function()
  it("should direct-list-collection", function()
    local setup = collection_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-collection", setup.live and "live" or "unit")
...
function collection_direct_setup(mockres)
