...
describe("WorkListDirect", function()
  it("should direct-load-work_list", function()
    local setup = work_list_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-work_list", setup.live and "live" or "unit")
...
function work_list_direct_setup(mockres)
