...
describe("TagDirect", function()
  it("should direct-load-tag", function()
    local setup = tag_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-tag", setup.live and "live" or "unit")
...
function tag_direct_setup(mockres)
