...
**Entities** (19): `Area`, `Artist`, `Collection`, `Event`, `Genre`, `Instrument`, `Label`, `Place`, `Rating`, `Recording`, `RecordingList`, `Release`, `ReleaseGroup`, `ReleaseList`, `Series`, `Tag`, `Url`, `Work`, `WorkList`.
