...
class MusicbrainzRbacFeature extends MusicbrainzBaseFeature
{
    ...
    private function _required(MusicbrainzContext $ctx): ?string
    {
    ...
    private function _reject(MusicbrainzContext $ctx, string $required): void
    {
    ...
    private function _track(MusicbrainzContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
