...
// Musicbrainz SDK clienttrack feature
...
class MusicbrainzClienttrackFeature extends MusicbrainzBaseFeature
{
    ...
    public function PostConstruct(MusicbrainzContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Musicbrainz-SDK';
