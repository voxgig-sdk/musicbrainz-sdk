...
// Musicbrainz SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class MusicbrainzTestFeature extends MusicbrainzBaseFeature
{
    ...
    public function init(MusicbrainzContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (MusicbrainzContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = MusicbrainzParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (MusicbrainzContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(MusicbrainzContext $ctx, $op, $args): array
    {
