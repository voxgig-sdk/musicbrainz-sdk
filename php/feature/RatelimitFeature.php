...
// Musicbrainz SDK ratelimit feature
...
class MusicbrainzRatelimitFeature extends MusicbrainzBaseFeature
{
    ...
    private function _acquire(MusicbrainzContext $ctx): void
    {
    ...
    private function _track(MusicbrainzContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
