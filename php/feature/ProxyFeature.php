...
class MusicbrainzProxyFeature extends MusicbrainzBaseFeature
{
    ...
    public function init(MusicbrainzContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (MusicbrainzContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
