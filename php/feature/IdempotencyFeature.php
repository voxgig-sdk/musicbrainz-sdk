...
// Musicbrainz SDK idempotency feature
...
class MusicbrainzIdempotencyFeature extends MusicbrainzBaseFeature
{
    ...
    private function _mutating(MusicbrainzContext $ctx): bool
    {
