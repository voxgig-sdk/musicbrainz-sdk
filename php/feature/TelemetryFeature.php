...
// Musicbrainz SDK telemetry feature
...
class MusicbrainzTelemetryFeature extends MusicbrainzBaseFeature
{
    ...
    private function _close(MusicbrainzContext $ctx, bool $ok): void
    {
