...
// Musicbrainz SDK utility: graphql
//
...
class MusicbrainzGraphql
{
    ...
    // equivalent.
    public static function body(MusicbrainzContext $ctx): mixed
    {
    ...
    public static function errors(MusicbrainzContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
