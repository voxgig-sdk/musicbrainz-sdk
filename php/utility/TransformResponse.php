...
// Musicbrainz SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class MusicbrainzTransformResponse
{
    public static function call(MusicbrainzContext $ctx): mixed
    {
        ...
        $transform = MusicbrainzHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
