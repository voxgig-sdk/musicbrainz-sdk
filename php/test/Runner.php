...
class MusicbrainzTestRunner
{
    ...
    {
        $live = self::getenv('MUSICBRAINZ_TEST_LIVE');
        $override = self::getenv('MUSICBRAINZ_TEST_OVERRIDE');
        ...
        $explain = self::getenv('MUSICBRAINZ_TEST_EXPLAIN');
...
class_alias('MusicbrainzTestRunner', 'Runner');
class_alias('MusicbrainzHelpers', 'Helpers');
