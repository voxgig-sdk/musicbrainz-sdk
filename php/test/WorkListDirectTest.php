...
class WorkListDirectTest extends TestCase
{
    public function test_direct_load_work_list(): void
    {
        $setup = work_list_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-work_list", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
