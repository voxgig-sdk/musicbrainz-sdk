...
class RecordingListDirectTest extends TestCase
{
    public function test_direct_load_recording_list(): void
    {
        $setup = recording_list_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-recording_list", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
