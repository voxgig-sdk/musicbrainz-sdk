...
// Musicbrainz SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (MusicbrainzSDK::test)
...
{
    private const SDK_CLASS = 'MusicbrainzSDK';
    ...
    private const SDK_BASE = 'musicbrainz_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../musicbrainz_sdk.php';
