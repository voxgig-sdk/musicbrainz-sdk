...
{
    public function test_direct_load_rating(): void
    {
        $setup = rating_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-rating", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
