...
class ReleaseListDirectTest extends TestCase
{
    public function test_direct_load_release_list(): void
    {
        $setup = release_list_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-release_list", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
