...
class CollectionDirectTest extends TestCase
{
    public function test_direct_list_collection(): void
    {
        $setup = collection_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-collection", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
