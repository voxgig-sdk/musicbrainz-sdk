...
// Musicbrainz SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = MusicbrainzOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(MusicbrainzOmni::structfix($now, Struct::undef()))
                        !== json_encode(MusicbrainzOmni::structfix($val, Struct::undef()))) {
