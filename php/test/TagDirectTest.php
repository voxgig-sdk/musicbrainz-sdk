...
class TagDirectTest extends TestCase
{
    public function test_direct_load_tag(): void
    {
        $setup = tag_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-tag", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
