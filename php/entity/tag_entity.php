...
class TagEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new TagEntity($this->_client, $opts);
    }

    /**
     * @param Tag|array $args Tag data (assoc-array) to store.
     */
    ...
    /**
     * @return Tag|array The current Tag data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Tag fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Tag fields).
     */
     ...
     * Load a single Tag.
     *
     * @param TagLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed TagLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Tag|array The loaded Tag as an assoc-array at the
     ...
     * Create a new Tag.
     *
     * @param TagCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed TagCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Tag|array The created Tag as an assoc-array at the
     *   SDK boundary; throws MusicbrainzError on failure (item-5 convention).
     */
