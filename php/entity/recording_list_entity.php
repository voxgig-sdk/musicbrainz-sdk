...
// Musicbrainz SDK RecordingList entity
...
class RecordingListEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new RecordingListEntity($this->_client, $opts);
    }

    /**
     * @param RecordingList|array $args RecordingList data (assoc-array) to store.
     */
    ...
    /**
     * @return RecordingList|array The current RecordingList data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of RecordingList fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of RecordingList fields).
     */
     ...
     *
     * @param RecordingListLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed RecordingListLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return RecordingList|array The loaded RecordingList as an assoc-array at the
