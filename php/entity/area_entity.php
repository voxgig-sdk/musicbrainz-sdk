...
class AreaEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new AreaEntity($this->_client, $opts);
    }

    /**
     * @param Area|array $args Area data (assoc-array) to store.
     */
    ...
    /**
     * @return Area|array The current Area data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Area fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Area fields).
     */
     ...
     * Load a single Area.
     *
     * @param AreaLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed AreaLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Area|array The loaded Area as an assoc-array at the
    ...
    /**
     * List Area items matching the given filter.
     *
     * @param AreaListMatch|array|null $reqmatch Match filter (any subset
     *   of Area fields) as an assoc-array; AreaListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Area[]|array A list of Area items as assoc-arrays at
