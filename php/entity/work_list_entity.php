...
// Musicbrainz SDK WorkList entity
...
class WorkListEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new WorkListEntity($this->_client, $opts);
    }

    /**
     * @param WorkList|array $args WorkList data (assoc-array) to store.
     */
    ...
    /**
     * @return WorkList|array The current WorkList data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of WorkList fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of WorkList fields).
     */
    ...
    /**
     * Load a single WorkList.
     *
     * @param WorkListLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed WorkListLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return WorkList|array The loaded WorkList as an assoc-array at the
