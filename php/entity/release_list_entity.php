...
// Musicbrainz SDK ReleaseList entity
...
class ReleaseListEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ReleaseListEntity($this->_client, $opts);
    }

    /**
     * @param ReleaseList|array $args ReleaseList data (assoc-array) to store.
     */
    ...
    /**
     * @return ReleaseList|array The current ReleaseList data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ReleaseList fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ReleaseList fields).
     */
    ...
    /**
     * Load a single ReleaseList.
     *
     * @param ReleaseListLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ReleaseListLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ReleaseList|array The loaded ReleaseList as an assoc-array at the
