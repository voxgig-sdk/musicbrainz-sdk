...
class LabelEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new LabelEntity($this->_client, $opts);
    }

    /**
     * @param Label|array $args Label data (assoc-array) to store.
     */
    ...
    /**
     * @return Label|array The current Label data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Label fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Label fields).
     */
     ...
     * Load a single Label.
     *
     * @param LabelLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed LabelLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Label|array The loaded Label as an assoc-array at the
     ...
     *
     * @param LabelListMatch|array|null $reqmatch Match filter (any subset
     *   of Label fields) as an assoc-array; LabelListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Label[]|array A list of Label items as assoc-arrays at
