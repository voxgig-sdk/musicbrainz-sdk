...
class RatingEntity
{
     ...
     *
     * @param RatingLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed RatingLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Rating|array The loaded Rating as an assoc-array at the
     ...
     * Create a new Rating.
     *
     * @param RatingCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed RatingCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Rating|array The created Rating as an assoc-array at the
     *   SDK boundary; throws MusicbrainzError on failure (item-5 convention).
     */
