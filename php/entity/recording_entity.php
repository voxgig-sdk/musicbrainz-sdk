...
// Musicbrainz SDK Recording entity
...
class RecordingEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new RecordingEntity($this->_client, $opts);
    }

    /**
     * @param Recording|array $args Recording data (assoc-array) to store.
     */
    ...
    /**
     * @return Recording|array The current Recording data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Recording fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Recording fields).
     */
     ...
     *
     * @param RecordingLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed RecordingLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Recording|array The loaded Recording as an assoc-array at the
    ...
    /**
     * List Recording items matching the given filter.
     *
     * @param RecordingListMatch|array|null $reqmatch Match filter (any subset
     *   of Recording fields) as an assoc-array; RecordingListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Recording[]|array A list of Recording items as assoc-arrays at
