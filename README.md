...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/musicbrainz` | `npm install @voxgig-sdk/musicbrainz` |
| Python | `voxgig-sdk-musicbrainz` | `pip install voxgig-sdk-musicbrainz` |
| PHP | `voxgig-sdk/musicbrainz` | `composer require voxgig-sdk/musicbrainz` |
| Golang | `github.com/voxgig-sdk/musicbrainz-sdk/go` | `go get github.com/voxgig-sdk/musicbrainz-sdk/go` |
| Ruby | `voxgig-sdk-musicbrainz` | `gem install voxgig-sdk-musicbrainz` |
| Lua | `voxgig-sdk-musicbrainz` | `luarocks install voxgig-sdk-musicbrainz` |
