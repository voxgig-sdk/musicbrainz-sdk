// Command Musicbrainz-mcp is an MCP server exposing the Musicbrainz
// SDK as MCP tools.
//
// Two tools are registered:
//
//	Musicbrainz_list  — list records of an entity
//	Musicbrainz_load  — load a single record of an entity
//
