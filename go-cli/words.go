...
func registerSDKWords(r *eng.Registry, client *sdk.MusicbrainzSDK) {
...
func runOp(client *sdk.MusicbrainzSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
