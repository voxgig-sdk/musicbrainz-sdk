...
class UrlEntity
  ...
  # @return [Url, Hash] the current Url data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Url fields)
  def match_get
  ...
  # Load a single Url.
  #
  # @param reqmatch [UrlLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Url.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Url, Hash] the loaded Url; raises MusicbrainzError on failure
  ...
  #
  # @param reqmatch [UrlListMatch, Hash, nil] match filter (any subset of
  #   Url fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Url>, Array] the matching Url items; raises MusicbrainzError on failure
