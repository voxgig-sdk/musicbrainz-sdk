...
class WorkListEntity
  ...
  def make
    opts = @_entopts.dup
    WorkListEntity.new(@_client, opts)
  end
  ...
  # @return [WorkList, Hash] the current WorkList data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of WorkList fields)
  def match_get
  ...
  #
  # @param reqmatch [WorkListLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.WorkList.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [WorkList, Hash] the loaded WorkList; raises MusicbrainzError on failure
