...
class PlaceEntity
  ...
  # @return [Place, Hash] the current Place data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Place fields)
  def match_get
  ...
  # Load a single Place.
  #
  # @param reqmatch [PlaceLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Place.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Place, Hash] the loaded Place; raises MusicbrainzError on failure
  ...
  #
  # @param reqmatch [PlaceListMatch, Hash, nil] match filter (any subset of
  #   Place fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Place>, Array] the matching Place items; raises MusicbrainzError on failure
