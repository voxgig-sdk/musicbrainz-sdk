...
class LabelEntity
  ...
  #   as an empty match, so client.Label.load works with no args).
  ...
  #
  # @param reqmatch [LabelListMatch, Hash, nil] match filter (any subset of
  #   Label fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
