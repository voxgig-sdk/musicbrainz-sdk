...
class AreaEntity
  ...
  # @return [Area, Hash] the current Area data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Area fields)
  def match_get
  ...
  # Load a single Area.
  #
  # @param reqmatch [AreaLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Area.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Area, Hash] the loaded Area; raises MusicbrainzError on failure
  ...
  #
  # @param reqmatch [AreaListMatch, Hash, nil] match filter (any subset of
  #   Area fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Area>, Array] the matching Area items; raises MusicbrainzError on failure
