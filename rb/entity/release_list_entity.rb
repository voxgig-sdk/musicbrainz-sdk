...
class ReleaseListEntity
  ...
  def make
    opts = @_entopts.dup
    ReleaseListEntity.new(@_client, opts)
  end
  ...
  # @return [ReleaseList, Hash] the current ReleaseList data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ReleaseList fields)
  def match_get
  ...
  #
  # @param reqmatch [ReleaseListLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.ReleaseList.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [ReleaseList, Hash] the loaded ReleaseList; raises MusicbrainzError on failure
