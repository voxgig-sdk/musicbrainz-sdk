...
class SeriesEntity
  ...
  #   as an empty match, so client.Series.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Series, Hash] the loaded Series; raises MusicbrainzError on failure
  ...
  #
  # @param reqmatch [SeriesListMatch, Hash, nil] match filter (any subset of
  #   Series fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Series>, Array] the matching Series items; raises MusicbrainzError on failure
