...
class CollectionEntity
  ...
  def make
    opts = @_entopts.dup
    CollectionEntity.new(@_client, opts)
  end
  ...
  #
  # @param reqmatch [CollectionListMatch, Hash, nil] match filter (any subset of
  #   Collection fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Collection>, Array] the matching Collection items; raises MusicbrainzError on failure
