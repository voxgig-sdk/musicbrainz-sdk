...
class WorkEntity
  ...
  # @return [Work, Hash] the current Work data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Work fields)
  def match_get
  ...
  # @return [Work, Hash] the loaded Work; raises MusicbrainzError on failure
  ...
  #
  # @param reqmatch [WorkListMatch, Hash, nil] match filter (any subset of
  #   Work fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Work>, Array] the matching Work items; raises MusicbrainzError on failure
