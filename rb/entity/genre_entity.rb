...
class GenreEntity
  ...
  #
  # @param reqmatch [GenreListMatch, Hash, nil] match filter (any subset of
  #   Genre fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
