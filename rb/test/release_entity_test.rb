...
class ReleaseEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    release_ref01_list_result, err = release_ref01_ent.list(release_ref01_match, nil)
    assert_nil err
    ...
    release_ref01_data_dt0_loaded, err = release_ref01_ent.load(release_ref01_match_dt0, nil)
    assert_nil err
