...
module MusicbrainzTestRunner
  ...
  def self.env_override(m)
    live = getenv("MUSICBRAINZ_TEST_LIVE")
    override = getenv("MUSICBRAINZ_TEST_OVERRIDE")
    ...
    explain = getenv("MUSICBRAINZ_TEST_EXPLAIN")
    m["MUSICBRAINZ_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = MusicbrainzTestRunner
Helpers = MusicbrainzHelpers
Vs = VoxgigStruct
