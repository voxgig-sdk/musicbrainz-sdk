...
// Musicbrainz SDK utility: fetcher
...
class MusicbrainzFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; MusicbrainzSDK/1.0)';
    ...
    public static function call(MusicbrainzContext $ctx, string $fullurl, array $fetchdef): array
    {
