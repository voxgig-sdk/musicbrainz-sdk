...
// Musicbrainz SDK timeout feature
...
class MusicbrainzTimeoutFeature extends MusicbrainzBaseFeature
{
    ...
    private function _with_timeout(MusicbrainzContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(MusicbrainzContext $_ctx, float $ms): void
    {
        $client = $this->client;
