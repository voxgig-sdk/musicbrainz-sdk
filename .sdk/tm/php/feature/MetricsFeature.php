...
// Musicbrainz SDK metrics feature
...
class MusicbrainzMetricsFeature extends MusicbrainzBaseFeature
{
    ...
    private function _record(MusicbrainzContext $ctx, bool $ok): void
    {
