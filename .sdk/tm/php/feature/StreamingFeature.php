...
// Musicbrainz SDK streaming feature
...
class MusicbrainzStreamingFeature extends MusicbrainzBaseFeature
{
    ...
    private function _iterate(MusicbrainzResult $result): \Generator
    {
    ...
    private function _streamable(MusicbrainzContext $ctx): bool
    {
