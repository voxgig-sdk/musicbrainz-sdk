...
class MusicbrainzCacheFeature extends MusicbrainzBaseFeature
{
    ...
    private function _through(MusicbrainzContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
