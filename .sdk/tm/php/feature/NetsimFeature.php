...
// Musicbrainz SDK netsim feature
...
class MusicbrainzNetsimFeature extends MusicbrainzBaseFeature
{
    ...
    private function _simulate(MusicbrainzContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(MusicbrainzContext $ctx, array $applied): void
    {
        $client = $this->client;
