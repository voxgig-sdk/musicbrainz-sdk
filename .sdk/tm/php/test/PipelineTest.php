...
{
    private static function utility(): MusicbrainzUtility
    {
        return new MusicbrainzUtility();
    }
    ...
    private static function ctx(array $over = []): MusicbrainzContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new MusicbrainzContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new MusicbrainzOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof MusicbrainzError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new MusicbrainzOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = MusicbrainzMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new MusicbrainzOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = MusicbrainzMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new MusicbrainzOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = MusicbrainzMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new MusicbrainzSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = MusicbrainzMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            ...
            'result' => new MusicbrainzResult([]),
        ]);
        [, $err] = MusicbrainzMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new MusicbrainzSpec([]),
            'response' => null,
            'result' => new MusicbrainzResult([]),
        ]);
        [, $err] = MusicbrainzMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new MusicbrainzSpec(['step' => 's']),
            'response' => new MusicbrainzResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new MusicbrainzResult([]),
        ]);
        [, $err] = MusicbrainzMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new MusicbrainzSpec(['step' => 's']),
            'response' => new MusicbrainzResponse(self::resp(200, ['v' => 1])),
            'result' => new MusicbrainzResult([]),
        ]);
        [, $err] = MusicbrainzMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new MusicbrainzSpec(['step' => 's']),
            'response' => new MusicbrainzResponse(self::resp(200, ['v' => 2])),
            'result' => new MusicbrainzResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        MusicbrainzMakeResponse::call($ctx);
    ...
    {
        $preset = new MusicbrainzResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new MusicbrainzSpec([]),
            'response' => new MusicbrainzResponse([]),
            'result' => new MusicbrainzResult([]),
        ...
        [$got, $err] = MusicbrainzMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new MusicbrainzResult([])]);
        [, $err] = MusicbrainzMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new MusicbrainzSpec([]), 'result' => null]);
        [, $err] = MusicbrainzMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new MusicbrainzSpec(['step' => 's']),
            'result' => new MusicbrainzResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new MusicbrainzOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = MusicbrainzMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new MusicbrainzSpec(['step' => 's']),
            'result' => new MusicbrainzResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new MusicbrainzOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = MusicbrainzMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new MusicbrainzResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new MusicbrainzSpec([]),
            'result' => new MusicbrainzResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = MusicbrainzMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = MusicbrainzMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new MusicbrainzError('boom', 'boom');
        $utility->fetcher = function (MusicbrainzContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new MusicbrainzSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = MusicbrainzMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (MusicbrainzContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = MusicbrainzMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(MusicbrainzResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        MusicbrainzMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (MusicbrainzContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new MusicbrainzSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = MusicbrainzMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new MusicbrainzResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new MusicbrainzSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = MusicbrainzMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = MusicbrainzMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = MusicbrainzMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new MusicbrainzResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, MusicbrainzDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new MusicbrainzResult(['ok' => false])]);
        $this->expectException(MusicbrainzError::class);
        MusicbrainzDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new MusicbrainzResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', MusicbrainzMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        MusicbrainzMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new MusicbrainzBaseFeature();
        $b = new MusicbrainzBaseFeature();
        MusicbrainzFeatureAdd::call($ctx, $a);
        MusicbrainzFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): MusicbrainzBaseFeature
    {
        $f = new MusicbrainzBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        MusicbrainzFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): MusicbrainzContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new MusicbrainzSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = MusicbrainzPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        MusicbrainzPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new MusicbrainzResponse(['headers' => null]),
            'result' => new MusicbrainzResult([]),
        ]);
        MusicbrainzResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        MusicbrainzResultBody::call($ctx);
