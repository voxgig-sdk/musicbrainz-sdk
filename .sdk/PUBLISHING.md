...
|---|---|---|
| `ts/` | @voxgig-sdk/musicbrainz-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/musicbrainz-sdk \
      --repository voxgig-sdk/musicbrainz-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/musicbrainz-sdk` shows it, and
`npm trust revoke @voxgig-sdk/musicbrainz-sdk --id=<id>` removes it.
